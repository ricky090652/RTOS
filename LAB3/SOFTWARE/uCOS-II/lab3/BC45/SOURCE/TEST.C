...
//     OSTCBCur->start = (INT32U)OSTimeGet();      
//     OSTCBCur->end = 0;
//     OS_EXIT_CRITICAL();
...
void PrintCtxSwMessage_DOS() {
    static int i = 0;
    static INT8U y_pos = 0; 

    for (; i < CtxSwMessageTop; i++) {
        PC_DispStr(0, y_pos, CtxSwMessage[i], DISP_FGND_WHITE + DISP_BGND_BLACK);
